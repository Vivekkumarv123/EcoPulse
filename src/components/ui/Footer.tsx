  ...
  return (
    <footer className="w-full mt-24 border-t border-white/[0.04] bg-gradient-to-b from-transparent to-white/[0.01]" role="contentinfo">
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 pb-12 border-b border-white/[0.03]">
          
          {/* Main Brand Section */}
          <div className="md:col-span-4 flex flex-col gap-4">
            <Link href="/" className="flex items-center gap-2 text-md font-bold text-white tracking-tight">
                ...
                <ul className="flex flex-col gap-2">
                  {group.links.map((link) => (
                    <li key={link.name}>
                      <Link
                        href={link.href}
                        className="text-xs font-medium text-slate-500 hover:text-emerald-400 transition-colors duration-200"
                      >
                        {link.name}
                      </Link>
                    </li>
        ...
        <div className="pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-[11px] font-medium text-slate-500 tracking-wide">
          ...
          <div className="flex items-center gap-5 order-1 sm:order-2 text-slate-600">
            <span className="flex items-center gap-1.5 hover:text-slate-400 transition-colors">
              <span className="w-1.5 h-1.5 rounded-full bg-slate-700"></span> Accessible
            </span>
            <span className="flex items-center gap-1.5 hover:text-slate-400 transition-colors">
              <span className="w-1.5 h-1.5 rounded-full bg-slate-700"></span> Privacy-First
            </span>
            <span className="flex items-center gap-1.5 hover:text-slate-400 transition-colors">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-500/40"></span> 99.9% Uptime
            </span>
          </div>
        </div>
