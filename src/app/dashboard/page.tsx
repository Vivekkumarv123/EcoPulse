...
export default function DashboardPage() {
  ...
  const metrics = [
    { label: "Transport", value: breakdown.transport || 0, color: DASHBOARD_METRICS_COLORS.TRANSPORT.color, text: DASHBOARD_METRICS_COLORS.TRANSPORT.text },
    { label: "Food", value: breakdown.food || 0, color: DASHBOARD_METRICS_COLORS.FOOD.color, text: DASHBOARD_METRICS_COLORS.FOOD.text },
    { label: "Energy", value: breakdown.energy || 0, color: DASHBOARD_METRICS_COLORS.ENERGY.color, text: DASHBOARD_METRICS_COLORS.ENERGY.text },
    { label: "Waste", value: breakdown.waste || 0, color: DASHBOARD_METRICS_COLORS.WASTE.color, text: DASHBOARD_METRICS_COLORS.WASTE.text },
  ];
