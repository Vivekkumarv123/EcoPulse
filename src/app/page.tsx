    ...
    <main className="w-full max-w-7xl mx-auto px-6 py-12 md:py-20 space-y-28 fade-in">
      ...
      <section className="card p-8 md:p-14 relative overflow-hidden group">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.02] border border-white/[0.06] text-slate-400 text-[11px] font-semibold tracking-widest uppercase mb-6 w-fit">
            ...
            <p className="mt-6 text-sm md:text-base text-slate-400 leading-relaxed max-w-xl">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <Link
                href="/assessment"
                className="inline-flex items-center justify-center px-6 py-3 rounded-xl text-xs font-bold text-slate-950 bg-emerald-400 hover:bg-emerald-300 active:scale-[0.98] transition-all duration-200 shadow-[0_0_24px_rgba(16,185,129,0.2)] hover:shadow-[0_0_32px_rgba(16,185,129,0.4)]"
              >
                Initialize Assessment
              </Link>
              <Link
                href="/dashboard"
                className="inline-flex items-center justify-center px-6 py-3 rounded-xl text-xs font-bold text-slate-200 bg-white/[0.02] hover:bg-white/[0.05] border border-white/[0.06] hover:border-white/[0.12] transition-all duration-200"
              >
                Launch Console
              </Link>
            </div>
          ...
          <div className="lg:col-span-5 hidden lg:block">
            <div className="w-full aspect-[4/3] rounded-2xl bg-gradient-to-br from-white/[0.03] to-transparent border border-white/[0.05] p-6 flex flex-col justify-between relative shadow-inner">
              <div className="flex justify-between items-start">
                <div>
                  <span className="text-[10px] uppercase font-bold tracking-widest text-slate-500 block">Emissions Target Index</span>
                  <span className="text-2xl font-mono font-black text-white mt-1 block">3.14 <span className="text-xs font-normal text-slate-400">MT CO₂e</span></span>
                </div>
              ...
              <div className="w-full h-24 flex items-end gap-1.5 px-2 opacity-30 group-hover:opacity-60 transition-opacity duration-500">
              ...
              <div className="text-[11px] font-medium text-slate-500 flex justify-between items-center border-t border-white/[0.04] pt-4">
      ...
      <section className="space-y-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-white/[0.04] pb-6">
          <div>
            <span className="text-xs font-bold tracking-widest uppercase text-emerald-400">System Pipeline</span>
            <h2 className="text-2xl md:text-3xl font-black tracking-tight text-white mt-1">Processing Architecture</h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {operationalPipeline.map((item) => (
            <div 
              key={item.index} 
              className="card group hover:bg-white/[0.02] hover:border-white/[0.08] transition-all duration-300 flex flex-col justify-between min-h-[250px]"
            >
              <div>
                <div className="flex items-center justify-between">
                  <div className="w-10 h-10 rounded-xl bg-white/[0.02] border border-white/[0.06] flex items-center justify-center group-hover:border-emerald-500/30 group-hover:bg-emerald-500/[0.02] transition-all duration-300">
                    {item.icon}
                  </div>
                  <span className="font-mono text-sm font-black text-slate-700 tracking-tighter group-hover:text-emerald-500/20 transition-colors">
                    {item.index}
                  </span>
                </div>
                
                <div className="mt-6">
                  <h3 className="text-base font-bold text-white tracking-tight">{item.phase}</h3>
              ...
              <p className="text-xs leading-relaxed text-slate-400 mt-5 border-t border-white/[0.02] pt-4 group-hover:border-white/[0.04] transition-colors">
                {item.details}
              </p>
            </div>
          ))}
      ...
      <section className="space-y-6">
        <div className="text-center max-w-xl mx-auto">
          <span className="text-xs font-bold tracking-widest uppercase text-emerald-400">Telemetry Evaluation</span>
          <h2 className="text-xl font-bold text-white tracking-tight mt-1">Impact Scenario Matrix</h2>
        ...
        <div className="p-1.5 bg-white/[0.01] border border-white/[0.03] rounded-3xl">
