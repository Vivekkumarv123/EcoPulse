...
## Objective
EcoPulse is designed to be usable by people with diverse abilities, including keyboard users and screen reader users. Accessibility is treated as a first-class feature in the application.
